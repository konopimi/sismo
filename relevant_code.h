...
<body>
      ...
      <div data-modal-body style="padding:0;flex:1;display:flex;flex-direction:column;overflow:hidden;">
        ...
        <div id="chatReplyBar"
          ...
          <div style="display:flex;align-items:center;gap:8px;">
            ...
            <button id="chatReplyCancel" type="button"
              style="flex:0 0 auto;padding:2px 8px;font-size:0.75rem;">✕</button>
          </div>
        </div>
        <div
  ...
  <div id="mediaLightbox" class="modal" role="dialog" aria-modal="true" style="padding:0;overflow:hidden;">
    <div class="modal-content"
      style="max-width:100%;max-height:100vh;width:100%;height:100%;border-radius:0;background:#000;">
      <div class="modal-header" data-modal-header style="background:rgba(0,0,0,0.6);">
        ...
        <button id="lightboxOcrToggle" type="button" title="Mostrar/ocultar texto OCR"
          style="flex:0 0 auto;padding:4px 10px;border-radius:6px;border:1px solid rgba(255,255,255,0.2);background:rgba(255,255,255,0.1);color:#fff;font-size:0.8rem;cursor:pointer;display:none;">📝
          OCR</button>
        <button class="modal-close" data-modal-close aria-label="Cerrar">✕</button>
      </div>
      <div data-modal-body
        ...
        <div id="lightboxStage"
          ...
          <!-- </div> -->
          <div id="lightboxOcr" style="display:none;width:100%;max-width:800px;margin:0 auto;padding:0 12px 12px;">
          </div>
          <!-- OCR Overlay (semi-transparent, full screen over the image) -->
          <div id="lightboxOcrOverlay"
            style="display:none;position:absolute;top:0;left:0;right:0;bottom:0;background:rgba(0,0,0,0.55);backdrop-filter:blur(6px);-webkit-backdrop-filter:blur(6px);z-index:10;overflow-y:auto;padding:60px 20px 20px;box-sizing:border-box;">
            <div
              style="max-width:800px;margin:0 auto;background:rgba(20,20,20,0.95);border:1px solid rgba(255,255,255,0.1);border-radius:12px;padding:20px;color:#eee;">
              <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:12px;">
                <div style="font-size:0.8rem;color:#45d6d6;font-weight:bold;">🧠 Texto extraído (OCR)</div>
                <button id="lightboxOcrCopy" type="button"
                  style="padding:6px 12px;border-radius:6px;border:1px solid rgba(69,214,214,0.5);background:rgba(69,214,214,0.15);color:#45d6d6;font-size:0.8rem;cursor:pointer;">📋
                  Copiar texto</button>
              </div>
              <pre id="lightboxOcrText"
                style="white-space:pre-wrap;word-break:break-word;font-family:inherit;font-size:0.9rem;line-height:1.6;max-height:60vh;overflow-y:auto;">
              </pre>
            </div>
          </div>
        </div>
